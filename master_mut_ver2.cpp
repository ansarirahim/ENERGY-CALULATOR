...
masterLow++;//masterCounter++;
}
while(inMUTGPIO.getValue()==1)
{
while(inMasterGPIO.getValue()==0);
while(inMasterGPIO.getValue()==1);
masterHigh++;//masterCounter++;
...
cout<<"MasterLow="<<masterLow<<" MasterHigh="<<masterHigh<<" Total="<<masterLow+masterHigh<<endl;//Counter="<<masterCounter<<endl;
