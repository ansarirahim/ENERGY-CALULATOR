...
#include <pthread.h>
#include <unistd.h>
//This will count till the number of pulse low levels //number of times low level counted and terminated as soon as last low pulse received

//./ultrasonic 10 100 
// this will count number of pulses low level to 10 with sample delay 100 ms
#define PRU_NUM 0
