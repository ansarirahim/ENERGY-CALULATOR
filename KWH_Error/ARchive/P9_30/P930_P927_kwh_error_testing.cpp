...
#define PATH_BIN "/root/160718/512/P9_30/P930_P937_kwh_testing.bin"
//P930_kwh.bin"
//P930.bin"
#define PRU_NUM 0
#include <fstream>  
...
sprintf(buffer,"/root/160718/512/P9_30/P930_P937_kwh_%u.bin",noofpulses);
///printf("%s\n",buffer);
//noofpulses=atoi(argv[1]);
//masterk=atoi(argv[2]);
//mutk=atoi(argv[3]);
...
master_energy=(1000.0/masterk)*ratio;
mut_energy=(1000.0/mutk)*0.78125*noofpulses;
...
printf("%u,%u,%lf,%lf,%lf,%lf,%lf\n", raw_counts,raw_countsP927,ratio,master_energy,mut_energy,error_energy,percent_error);
