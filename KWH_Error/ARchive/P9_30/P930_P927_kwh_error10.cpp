...
#define PATH_BIN "/root/160718/512/P9_30/P930_P937_kwh_10.bin"
//P930_kwh.bin"
//P930.bin"
#define PRU_NUM 0
#include <fstream>  
...
printf("%u,%u,%lf,%lf,%lf,%lf,%lf", raw_counts,raw_countsP927,ratio,master_energy,mut_energy,error_energy,percent_error);
